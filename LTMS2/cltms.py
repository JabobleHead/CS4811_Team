...
class Node:
    def __init__(self, datum: Any, id: int):
        self.id = id
        self.datum = datum
        self.label = Polarity.UNKNOWN
        
        # What justifies ME?
        self.supporting_justification: Optional['Justification'] = None
        
        # What justifies ME (specifically assumptions)?
        self.assumptions: Set[Any] = set()
        
        # What do I justify? (outgoing links)
